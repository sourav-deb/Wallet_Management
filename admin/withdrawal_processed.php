...
<head>
    ...
    <title>All Withdrawal</title>

    <!-- Add Font Awesome for icons -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="./assets/css/withdrawal_processed.css">
...
<body>
                ...
                <div class="filter-container">
                    <div class="filter-section">
                        <div class="form-grid">
                            ...
                            <form action="./process/all_withdrawal.php" method="POST" class="filter-form">
                                <!-- Retailer Id -->
    ...
    <div class=" modal" id="editModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm" action="./process/all_withdrawal.php" method="POST">
                    ...
                    <div class="modal-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="transfered_to" name="transfered_to" required readonly>
                        </div>
                    ...
                    <button type="submit" class="btn-save" name="update_withdrawal">Commissioned</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script src="./assets/js/withdrawal_processed.js"></script>
</body>
