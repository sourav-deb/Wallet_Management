...
<head>
    ...
    <title>Processed Withdrawal</title>
        ...
        <div class="content-wrapper">
            ...
            <header class="main-header">
                <div class="header-left">
                    ...
                    <div class="header-text">Processed Withdrawal</div>
                </div>
                    ...
                    <div class="table-container">
                        <table class="custom-table">
                            ...
                            <tbody>
                                <!-- display data here -->
                                <?php
                                $pay_req = mysqli_query($conn, "SELECT * FROM withdrawal_processed ORDER BY id DESC");
