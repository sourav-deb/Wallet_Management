...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/new_payment.css">
...
<body>
                    ...
                    <div class="table-container">
                        <table class="custom-table">
                            ...
                            <tbody>
                                <!-- display data here -->
                                <?php
                                $pay_req = mysqli_query($conn, "SELECT * FROM payment_req WHERE status = 'pending' ORDER BY id DESC");
    ...
    <script src="./assets/js/new_payment.js"></script>
</body>
