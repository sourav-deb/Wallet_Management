<?php
    ...
    if(isset($_POST['edit_customer'])){
        ...
        $query = "UPDATE customer SET cust_name = '$name', cust_email = '$email', cust_phone = '$phone', commission_type = '$comm_type', commission_value = '$comm_value', wallet_balance = '$wallet_balance', status = '$status' WHERE cust_id = '$id'";
