...
document.querySelectorAll('.btn-action.edit').forEach(button => {
    button.addEventListener('click', function() {
        ...
        const data = {
            ...
            transferedBy: row.querySelector('td:nth-child(3)').textContent,
            accountno: row.querySelector('td:nth-child(4)').textContent,
            amount: row.querySelector('td:nth-child(6)').textContent,
        ...
        document.getElementById('deposited_by').value = data.transferedBy;
        document.getElementById('transfered_to').value = data.accountno;
